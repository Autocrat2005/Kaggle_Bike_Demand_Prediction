...
Original file is located at
    https://colab.research.google.com/drive/1KJwqLSb7Oioe7nSXRrOVNHNIuPNa-aDc
"""
...
bikes_prep.hist(rwidth=0.9)
 ...
 plt.subplot(3, 3, 1)
 plt.title('Average Demand For The Season')
 cat_list = bikes_prep['season'].unique()
...
corelation = bikes_prep[['temp', 'atemp', 'humidity', 'windspeed', 'demand']]
...
bikes_prep = np.log(bikes_prep['demand'])
